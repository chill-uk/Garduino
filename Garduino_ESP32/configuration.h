...
#define MY_CHANNEL_NUMBER 0  // Replace the 0 with your channel number
#define MY_WRITE_API_KEY "XXXXXXXXXX"    // Paste your ThingSpeak Write API Key between the quotes
...
#define soilMoistureMin 1450
#define soilMoistureMax 3270
